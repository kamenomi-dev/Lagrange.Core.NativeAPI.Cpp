...
namespace Lagrange::Definition::InterimModel::Common {
struct BotKeystoreParser {
    static void Parse(
        const std::string file, Definition::NativeModel::Common::BotKeystore& result
    ) {
        ...
        try {
            ...
            result = Definition::NativeModel::Common::BotKeystore();
    ...
    static void Dump(
        const std::string file, Definition::NativeModel::Common::BotKeystore out
    ) {
        Utils::FileBinaryHelper helper{file};
        try {
